...
namespace AForge.Video
{
	...
	// mc++ using System.Drawing.Imaging;
	...
	/// </remarks>
	/// 
	public partial class AsyncVideoSource : IVideoSource
	{
		private readonly IVideoSource nestedVideoSource = null;
		private System.Drawing.Bitmap lastVideoFrame = null;
		...
		private static System.Drawing.Bitmap CloneImage(System.Drawing.Bitmap source)
		{
			...
			// create new image
			System.Drawing.Bitmap destination = CloneImage(sourceData);
			...
			//
			if (
				(source.PixelFormat == System.Drawing.Imaging.PixelFormat.Format1bppIndexed) ||
				(source.PixelFormat == System.Drawing.Imaging.PixelFormat.Format4bppIndexed) ||
				(source.PixelFormat == System.Drawing.Imaging.PixelFormat.Format8bppIndexed) ||
				(source.PixelFormat == System.Drawing.Imaging.PixelFormat.Indexed))
			{
				System.Drawing.Imaging.ColorPalette srcPalette = source.Palette;
				System.Drawing.Imaging.ColorPalette dstPalette = destination.Palette;
		...
		private static System.Drawing.Bitmap CloneImage(System.Drawing.Imaging.BitmapData sourceData)
		{
			...
			// create new image
			System.Drawing.Bitmap destination = new System.Drawing.Bitmap(width, height, sourceData.PixelFormat);

			// lock destination bitmap data
			System.Drawing.Imaging.BitmapData destinationData = destination.LockBits(
				new System.Drawing.Rectangle(0, 0, width, height),
				System.Drawing.Imaging.ImageLockMode.ReadWrite, destination.PixelFormat);
